...
/**
 * Static copy of backend/menu.py SEED_MENU_ITEMS / SEED_COMBOS.
 * Used so the Menu page always shows today's items even if
...
export const FALLBACK_COMBOS: Combo[] = [
  // Breakfast combos
  { id: "combo_ragi_idli", name: "Ragi Idli Combo", mealType: "breakfast", dietType: "veg", items: ["Ragi Idli (2 pcs)", "Sambar", "Coconut Chutney"], energyKcal: 250, proteinG: 7, carbsG: 38, fatG: 6, price: 80 },
  { id: "combo_masala_dosa", name: "Masala Dosa Combo", mealType: "breakfast", dietType: "veg", items: ["Masala Dosa", "Coconut Chutney", "Sambar"], energyKcal: 330, proteinG: 8, carbsG: 42, fatG: 12, price: 100 },
  { id: "combo_set_dosa", name: "Set Dosa Combo", mealType: "breakfast", dietType: "veg", items: ["Set Dosa (3 pcs)", "Coconut Chutney", "Sambar"], energyKcal: 280, proteinG: 8, carbsG: 40, fatG: 7, price: 90 },
  { id: "combo_paddu", name: "Paddu Combo", mealType: "breakfast", dietType: "veg", items: ["Paddu (6 pcs)", "Coconut Chutney"], energyKcal: 240, proteinG: 6, carbsG: 33, fatG: 7, price: 80 },
  { id: "combo_puri_saagu", name: "Puri-Saagu Combo", mealType: "breakfast", dietType: "veg", items: ["Puri (3 pcs)", "Veg Saagu"], energyKcal: 380, proteinG: 7, carbsG: 38, fatG: 19, price: 90 },
  // Lunch / dinner — veg
  { id: "combo_veg_thali", name: "Veg Thali", mealType: "lunch_dinner", dietType: "veg", items: ["White Rice", "Chapati (2 pcs)", "Dal", "Mixed Veg Curry", "Curd"], energyKcal: 600, proteinG: 18, carbsG: 95, fatG: 12, price: 150 },
  { id: "combo_pulav_raita", name: "Pulav & Raita Combo", mealType: "lunch_dinner", dietType: "veg", items: ["Veg Pulav", "Curd Raita"], energyKcal: 320, proteinG: 8, carbsG: 46, fatG: 11, price: 150 },
  { id: "combo_jeera_dal", name: "Jeera Rice & Dal Combo", mealType: "lunch_dinner", dietType: "veg", items: ["Jeera Rice", "Dal", "Buttermilk"], energyKcal: 330, proteinG: 11, carbsG: 48, fatG: 7, price: 150 },
  // Lunch / dinner — non-veg
  { id: "combo_chicken_curry_meal", name: "Chicken Curry Meal", mealType: "lunch_dinner", dietType: "nonveg", items: ["White Rice / Jolada Roti (2 pcs)", "Chicken Curry", "Curd Raita"], energyKcal: 590, proteinG: 28, carbsG: 60, fatG: 25, price: 200 },
  { id: "combo_egg_curry_meal", name: "Egg Curry Meal", mealType: "lunch_dinner", dietType: "nonveg", items: ["White Rice", "Egg Curry", "Buttermilk"], energyKcal: 490, proteinG: 19, carbsG: 57, fatG: 19, price: 180 },
  { id: "combo_mutton_curry_meal", name: "Mutton Curry Meal", mealType: "lunch_dinner", dietType: "nonveg", items: ["White Rice", "Mutton Curry", "Curd Raita"], energyKcal: 620, proteinG: 28, carbsG: 59, fatG: 29, price: 200 },
  { id: "combo_chicken_fried_rice", name: "Chicken Fried Rice Combo", mealType: "lunch_dinner", dietType: "nonveg", items: ["Chicken Fried Rice", "Buttermilk"], energyKcal: 440, proteinG: 20, carbsG: 54, fatG: 16, price: 190 },
  { id: "combo_egg_bhurji_power", name: "Egg Burji Power Combo", mealType: "lunch_dinner", dietType: "nonveg", items: ["Ragi Mudde", "Egg Burji", "Buttermilk"], energyKcal: 440, proteinG: 19, carbsG: 46, fatG: 19, price: 180 },
];
